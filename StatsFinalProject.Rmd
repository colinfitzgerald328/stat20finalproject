...
ggplot(nba2019,aes(x=salary/1000000,y=pts))+geom_point(alpha=0.5,size=0.5,color="blue")+geom_smooth(method=lm,se=F,color="red")+labs(title="Salary vs. Points, NBA 2019",x="2019 NBA Salary (millions of dollars)",y="Average Points Per Game")
```
